...
export async function AttemptToUpdateOldModel({ hobbies, recipes, userID }: { hobbies: IHobby[], recipes: IRecipe[], userID: string }) {
    ...
    try {
        ...
        const updatedFields = await fetch(`/api/transferOldObjects`, {
            method: 'PUT',
            headers: {
