  ...
  return (
    <>
      ...
      <Accordion defaultPanel={''}>
        <AccordionItem toggle="panel-1" className="text-black hover:text-slate-400 text-xs px-10 rounded-lg px-3 py-5">
        ...
        <AccordionPanel id="panel-1">
          {classesOpenMats.map((item, index) => (
            <div key={index} className="mb-4 px-2 py-1 cursor-pointer">
              <Link onClick={toggle} href={''} className={`px-10 rounded-lg px-3 py-5 text-black text-xs hover:text-slate-400`}>
                - {item}
              </Link>
            </div>
          ))}
        </AccordionPanel>
        <AccordionItem toggle="panel-2" className="text-black hover:text-slate-400 text-xs px-10 rounded-lg px-3 py-5">
          News
        </AccordionItem>
        ...
        <AccordionItem toggle="panel-3" className="text-black hover:text-slate-400 text-xs px-10 rounded-lg px-3 py-5">
          Special Offers
        </AccordionItem>
        ...
        <div className="block text-black hover:text-slate-400 text-xs px-10 rounded-lg px-3 py-5 cursor-pointer">
        ...
        <AccordionItem toggle="panel-4" className="text-black hover:text-slate-400 text-xs px-10 rounded-lg px-3 py-5">
          About
        </AccordionItem>
