...
export default function LandingPage() {
    ...
    return (
        ...
        <SectionWrapper varHeight="h-[90%]" extraProps="flex flex-col justify-between items-center p-2 py-6 md:py-5 md:p-5">
            <div className="flex flex-row justify-between items-center p-1 md:p-2 w-full min-h-[64px] sm:min-h-[67.88px] md:min-h-[126.94]">
            ...
            {!fadeOutBegin && fadeInBegin ? <SocialBar fadeOutBegin={fadeOutBegin} fadeInBegin={fadeInBegin} /> : shell ? <div className={`flex flex-row justify-evenly items-center w-full px-2 md:w-2/3 sm:h-[45px] h-[28px]`} /> : null}
        </SectionWrapper>
    );
}