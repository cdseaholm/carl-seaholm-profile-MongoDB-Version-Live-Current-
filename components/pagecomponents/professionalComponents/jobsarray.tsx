...
},
{
    ...
    "Take 20 daily   leads to keep pipeline and sequences fresh and up to date",
...

{
    ...
    company: '  Progress WordPress site',
    title: "Owner and Operator of   Progress Blog",
