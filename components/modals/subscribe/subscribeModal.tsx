...
export default function ModalSubscribe() {
    ...
    return (
        <>
        <div id="crud-modal" tabIndex={-1} aria-hidden="true" className={`${modalSubscribeOpen ? 'flex' : 'hidden'} overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full backdrop-blur-sm`}>
                ...
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        <h3 className={`${isBreakpoint ? '' : 'text-lg'} font-semibold text-gray-900 dark:text-white`}>
                            ...
                            <button type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="crud-modal" onClick={() => setModalSubscribeOpen(false)}>
                    ...
                    <form id="modalSubscribeForm" className="p-4 md:p-5" onSubmit={handleSub}>
                        <div className="grid gap-4 mb-6 grid-cols-2">
                            <label htmlFor="modalSubEmail" className={`block my-2 ${textSize} font-medium text-gray-900 dark:text-white`}>Email*</label>
                            ...
                            <label htmlFor="modalSubName" className={`block my-2 ${textSize} font-medium text-gray-900 dark:text-white`}>Name</label>
