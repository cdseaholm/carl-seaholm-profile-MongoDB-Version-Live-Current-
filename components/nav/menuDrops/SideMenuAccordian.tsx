  ...
  return (
    <>
      ...
      <div className="mb-4 px-2 py-1 cursor-pointer">
          <Link onClick={toggle} href={"/projects/npapps"} className={`px-10 rounded-lg px-3 py-5 text-slate-200 text-sm text-sm hover:text-slate-400 ${pathname === "/projects/npapps" ? "underline" : ""}`}>
