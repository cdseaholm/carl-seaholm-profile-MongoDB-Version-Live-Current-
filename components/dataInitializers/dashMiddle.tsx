...
export default function DashMiddle() {
    ...
    const handleDateIncrease = () => {
        const date = new Date(daySelected ? daySelected : new Date().toLocaleDateString());
    ...
    return (
        <DashProvider
            ...
            daySelected={daySelected ? daySelected : new Date().toLocaleDateString()}
            sessionsFound={dashProps ? dashProps.sessionsFound : [] as IIndexedEntry[]}
