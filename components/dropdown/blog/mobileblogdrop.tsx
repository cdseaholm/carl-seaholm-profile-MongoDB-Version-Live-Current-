    ...
    return (
        ...
        <div className='flex justify-end pt-5 py-5'>
            <div className='flex flex-col w-100'>
                ...
                <MobileDropDown 
                    menuStyle={`absolute right-2 z-30 py-1 px-1 text-left border border-gray-300 rounded-sm mt-9 mb-0 bg-clip-padding bg-slate-800/70 text-white shadow-lg w-32  cursor-pointer`} 
                    dropdownStyle={`absolute right-20 z-10 flex w-32 text-black rounded bg-slate-300 text-sm justify-between`}
                    itemsToFilter={categoriesForDrop} 
                    setContextName={(contextName: string) => setContextName(contextName)}
